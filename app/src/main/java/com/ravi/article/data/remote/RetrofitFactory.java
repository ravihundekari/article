...
import com.ravi.article.BuildConfig;
import com.ravi.article.data.remote.errorhandler.RxErrorCallAdapterFactory;
...
public class RetrofitFactory {
    ...
    public static Retrofit getRetrofit(OkHttpClient okHttpClient, ObjectMapper objectMapper) {
        return new Retrofit.Builder()
                .baseUrl(Constants.ARTICLE_SERVER_ENDPOINT)
                .client(okHttpClient)
